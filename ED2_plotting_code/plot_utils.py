...
mpl.use('Agg') # allow plotting without X11
...
PFT_COLORS = np.array([
    ...
    'xkcd:light sage',
    'xkcd:jade', #cyan
    'xkcd:blood orange', #dark orange; #dusty orange; #olive
    'xkcd:light indigo', #deep lilac; #dark periwinkle; #red
    'xkcd:blue',
    'xkcd:ruby',
    'xkcd:ruby',
    'xkcd:lilac',
...
#######################
# This is based on the new data structure
...
def forest_2d_overview(
    ...
    # some constant for plot
    site_x = 100. # m  ##EO was 70
    site_y = 100. # m  ##EO was 70
    ...
    ax.set_xticks([0.,100.])  ##EO was 70
    ax.set_yticks([0.,100.])  ##EO was 70
